USE [opvd]		-- Inserir o nome do banco entre []
GO
select db_name()
go
set nocount on
...
go
USE [opvd_wk]		-- Inserir o nome do banco entre []
GO
select db_name()
go
set nocount on
...
go
USE [opvd_hist]		-- Inserir o nome do banco entre []
GO
select db_name()
go
set nocount on
...
go
USE [optemp]		-- Inserir o nome do banco entre []
GO
select db_name()
go
set nocount on
