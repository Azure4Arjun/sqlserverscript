...
-- Check the major product version to see if it is 10.5
...
-- Hardware information from SQL Server 2008 R2  (Query 8) (Hardware Info)
...
-- Top cached queries by Execution Count (SQL Server 2008 R2)  (Query 36) (Query Execution Counts)
...
-- Top Cached SPs By Execution Count (SQL 2008 R2) (SQL 2008 R2 SP1 only) (Query 37) (SP Execution Counts)
...
-- Top Cached SPs By Avg Elapsed Time (SQL 2008 R2)  (Query 38) (SP Avg Elapsed Time) 
...
-- Top Cached SPs By Total Worker time (SQL 2008 R2). Worker time relates to CPU cost  (Query 40) (SP Worker Time)
...
-- Top Cached SPs By Total Logical Reads (SQL 2008 R2). Logical reads relate to memory pressure  (Query 41) (SP Logical Reads)
...
-- Top Cached SPs By Total Physical Reads (SQL 2008 R2). Physical reads relate to disk I/O pressure  (Query 42) (SP Physical Reads)
...
-- Top Cached SPs By Total Logical Writes (SQL 2008 R2)  (Query 43) (SP Logical Writes)
...
-- Get SQL Server Agent jobs and Category information (Query 57) (SQL Server Agent Jobs)
...
-- Get SQL Server Agent Alert Information (Query 58) (SQL Server Agent Alerts)
