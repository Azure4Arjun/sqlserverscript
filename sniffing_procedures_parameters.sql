...
SELECT @dbname = 'celtrak_data',
       @procname = 'dbo.ws_reefer_history_with_all_alarms'
----
SELECT *
FROM sys.dm_exec_cached_plans t1
  INNER JOIN syscacheobjects t2
    ON t1.bucketid = t2.bucketid
WHERE t2.objid = OBJECT_ID(@procname)
ORDER BY t2.dbid,t2.usecounts DESC,t2.objtype
GO
----
